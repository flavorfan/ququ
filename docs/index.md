...
|------|-------|---------|------|---------|
| [@docs/testing.md](testing.md) | 测试体系规范 | 分层测试架构总结：自动化 JS/Python 测试、环境自检、手工 smoke 的分类、运行方式、目录结构、当前覆盖和后续规划 | Testing, CI, Automation, JavaScript, Python, Pytest, Vitest | 2026-05-04 |
| [@docs/windows-embedded-python-fix.md](windows-embedded-python-fix.md) | Windows 嵌入式 Python 修复复盘 | 复盘 Windows 下 prepare/test 失败问题，梳理根因（pip 入口、路径硬编码、EFTYPE）并给出跨平台修复与验证结果 | Windows, Python, Embedded Runtime, FunASR, Build, Troubleshooting | 2026-05-04 |
